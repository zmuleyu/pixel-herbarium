...
jest.mock('@/constants/theme', () => ({
  colors: {
    ...
    blushPink: '#f5d5d0', skyBlue: '#d4e4f7', creamYellow: '#fff8dc',
  },
  typography: {
...
describe('LoginScreen', () => {
  ...
  it('renders password text input (secureTextEntry)', () => {
    const output = renderToString();
    expect(output).toContain('"secureTextEntry":true');
  });

  it('renders sign-in button with auth.signIn text', () => {
    const output = renderToString();
    expect(output).toContain('auth.signIn');
  });
